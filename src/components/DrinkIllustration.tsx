...
function getDynamicSakeFrame(seed: string) {
  ...
  const palette = [
    { frame: "#6d5b3f", surface: "#dcc786", glow: "#f0e6bc" },
    { frame: "#766850", surface: "#ddd0a7", glow: "#eee6cf" },
    { frame: "#7a604d", surface: "#d2b093", glow: "#e7d4c7" },
    { frame: "#6c4f43", surface: "#c9907f", glow: "#e2c0b4" },
    { frame: "#6e624e", surface: "#c8b791", glow: "#e3dbc8" },
    { frame: "#5d6652", surface: "#adb79b", glow: "#dbe1d3" },
    { frame: "#59624a", surface: "#a5b18a", glow: "#d4dbc7" },
    { frame: "#6a625d", surface: "#c4b9b0", glow: "#e1dbd7" },
    { frame: "#624f45", surface: "#b99b8d", glow: "#dcc9bf" },
    { frame: "#6a554b", surface: "#c3a08e", glow: "#e2c9bc" },
    { frame: "#6d6559", surface: "#b8afa1", glow: "#dad5ce" },
    { frame: "#65564b", surface: "#c0aa95", glow: "#dfd0c3" },
    { frame: "#4c5f69", surface: "#9fb6c1", glow: "#d8e3e9" },
    { frame: "#505d70", surface: "#a5b2c7", glow: "#dce2ee" },
    { frame: "#47615f", surface: "#98b6b1", glow: "#d3e2de" },
    { frame: "#5b5974", surface: "#b0acc7", glow: "#e1dfeb" },
    { frame: "#4f6457", surface: "#a5bcad", glow: "#d8e5dc" },
    { frame: "#646177", surface: "#beb8cc", glow: "#e6e3ec" },
  ];
